<?php
   ...
   if (!$result) 
         ...
         $query = "UPDATE `user` SET `username` = '$username_save', `email` = '$email_save', `discord` = '$discord_save', `age` = '$age_save', `password` = '$password_save', `password2` = '$password_save' WHERE `user_id` = $id;";
...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/rocket_league.css">
   ...
   <body>
      ...
      <div id="left-nav2">
         <div class="card-container">
            ...
            <div class="clip1">
                  <a href="updatephoto_rl.php" title="Change Profile Picture">
            ...
            <section>
               <details>
                  <summary>
                     <div class="edit_info">
                        <div class="btn-comment"><h5 class="button"> Edit Profile</h5></div>
                     </div>
                     ...
                     <div class="details-modal-title_profile">
                        <form method="post">
                           <div class="profile_info">
                              ...
                              <div class="password">
                                 <h3>Password</h3>
                                 <input type="text" name="password" value="<?php echo $password; ?>" class="form-1" required />
                              </div>
                              <div class="password2">
                                 <h3>Repeat Password</h3>
                                 <input type="text" name="password2" value="<?php echo $password2; ?>" class="form-1" required />
                              </div>
      ...
      <?php
                 		...
                 		$query= mySQLi_query($con,"SELECT * from post LEFT JOIN user on user.user_id = post.user_id WHERE category_id = 1 order by post_id DESC");
                 		while($row = mySQLi_fetch_array($query)){
      ...
      <div class="tools">
         ...
         <br>
         <div class="trash2">
            <a href="delete_post_rl.php<?php echo '?id='.$post_id; ?>" title="Delete your post">
               <img  src="css/trash2.png"></a>
            </div>
         </div>
         <div class="post_time">
         ...
         <?php
            ...
            ?>
         <div class="commentor">
            <form method="POST" action="comment_rl.php">
